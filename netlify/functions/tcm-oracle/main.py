...
def handler(event, context):
    ...
    try:
        ...
        # The TCM Brain Prompt
        prompt = f"You are an expert TCM Practitioner. Answer this strictly in Chinese Medical terms (Pattern -> Principle -> Points). Question: {question}"
