    ...
    <>
      ...
      <section className="py-20 bg-gradient-to-br from-gold/10 via-background to-jade/10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* Clinic CRM Inquiry CTA */}
          <div className="bg-gradient-to-r from-gold/10 to-jade/10 border border-gold/30 rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-bold mb-3">Interested in Clinic CRM?</h3>
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Contact us via WhatsApp for a personalized demo and special onboarding pricing
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={() => {
                  const message = encodeURIComponent("Hi! I'm interested in the Clinic CRM system for TCM practitioners. I'd like to learn more about the features and pricing.");
                  window.open(`https://wa.me/972544634923?text=${message}`, '_blank');
                }}
              >
