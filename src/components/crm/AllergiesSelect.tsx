                    ...
                    <CollapsibleContent className="pl-4 mt-1 space-y-1">
                      {category.allergens.map((allergen) => (
                        ...
                        >
                          ...
                          {/*
                           * NOTE: We intentionally use native title tooltips here.
                           * Radix Tooltip in this section caused a "Maximum update depth exceeded" crash
                           * (likely due to ref-churn in large lists).
                           */}
                          <button
                            type="button"
                            ...
                            title={[
                              `Western: ${allergen.westernView}`,
                              `TCM: ${allergen.tcmPerspective}`,
                              `Symptoms: ${allergen.symptoms}`,
                              `Severity: ${allergen.severity}`,
                            ].join('\n')}
                            aria-label={`Allergy info: ${allergen.name}`}
                          >
