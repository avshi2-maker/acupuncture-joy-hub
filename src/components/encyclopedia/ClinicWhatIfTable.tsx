...
const DEFAULT_TAGS = ['optimistic', 'conservative', 'baseline', 'israel-focus', 'global-focus', 'q1', 'q2', 'q3', 'q4', '2025', '2026', 'growth', 'test'];
...
export function ClinicWhatIfTable() {
  ...
  const getShareText = () => {
    return `📊 Clinic CRM ROI Scenario
      ...
      <Dialog open={isShareDialogOpen} onOpenChange={setIsShareDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            />
            <div className="flex gap-2">
              <Button onClick={copyShareText} className="flex-1 gap-2">
                <Copy className="h-4 w-4" />
                Copy to Clipboard
              </Button>
